...
const Signup = () => {
  ...
  const handleSubmit = async (e) => {
      ...
      try {
          const response = await axios.post(REGISTER_URL,
              JSON.stringify({ name: user, password: pwd, email, contactNo: contactNumber }),
              {
  ...
  return (
    <section className='w-screen h-screen bg-gradient-to-r from-indigo-500 to-sky-500 flex flex-row'>
      <div className='m-auto mx-4 md:mx-10 w-100 flex flex-col sm:flex-row items-center justify-evenly bg-slate-200 p-0 md:p-10 rounded-3xl'>
          <div className='w-1/2'>
            placeholder logo
          </div>
          <div className="bg-slate-200 w-1/2 rounded-lg shadow-lg">
